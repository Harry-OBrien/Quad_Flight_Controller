...
#pragma warning(disable : 4201)
		...
		public:
			...
			///
			/// \param[in] val The initialization value.
			explicit mat(T val) : e00(val), e10(val),
								  e01(val), e11(val)
			{
			}
			...
			mat(T e00v, T e01v,
				T e10v, T e11v) : e00(e00v), e10(e10v),
								  e01(e01v), e11(e11v)
			{
			}
			...
			mat(vec<2, T> col0, vec<2, T> col1) : e00(col0.x), e10(col1.x),
...
#pragma warning(pop)
		...
		public:
			...
			///
			/// \param[in] val The initialization value.
			explicit mat(T val) : e00(val), e10(val), e20(val),
			...
			mat(T e00v, T e01v, T e02v,
				...
				T e20v, T e21v, T e22v) : e00(e00v), e10(e10v), e20(e20v),
			...
			/// \param[in] col1 The 1 column vector.
			/// \param[in] col2 The 2 column vector.
			mat(vec<3, T> col0, vec<3, T> col1, vec<3, T> col2) : e00(col0.x), e10(col0.y), e20(col0.z),
...
#pragma warning(pop)
		...
		public:
			...
			///
			/// \param[in] val The initialization value.
			explicit mat(T val) : e00(val), e01(val), e02(val), e03(val),
			...
			mat(T e00v, T e01v, T e02v, T e03v,
				...
				T e30v, T e31v, T e32v, T e33v) : e00(e00v), e01(e01v), e02(e02v), e03(e03v),
			...
			/// \param[in] col2 The 2 column vector.
			/// \param[in] col3 The 3 column vector.
			mat(vec<4, T> col0, vec<4, T> col1, vec<4, T> col2, vec<4, T> col3) : e00(col0.x), e10(col1.x), e20(col2.x), e30(col3.x),
